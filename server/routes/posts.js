...
router.post("/", authMiddleware, async (req, res) => {
  ...
  try {
    const query =
      "INSERT INTO posts (title, slug, content, author_id, category_id, featured_image_url, featured_image_public_id) VALUES ($1, $2, $3, $4, $5, $6, $7) RETURNING id";
...
router.put("/:id", authMiddleware, async (req, res) => {
  ...
  try {
    const query =
      "UPDATE posts SET title = $1, slug = $2, content = $3, category_id = $4, featured_image_url = $5, featured_image_public_id = $6 WHERE id = $7 AND author_id = $8";
    const result = await db.query(query, [
      title,
      slug,
      content,
